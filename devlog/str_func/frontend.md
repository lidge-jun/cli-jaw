# Frontend — public/ (18 files, ~2500L)
...
│   ├── chat.css          ← 채팅, 메시지, 타이핑, 첨부, 드롭다운, 멈춤 버튼 (355L)
...
└── js/
    ...
    └── features/
        ├── chat.js       ← 전송, 첨부, 드래그앤드롭, 멈춤, 큐 (144L)
        ...
        └── slash-commands.js ← 슬래시 커맨드 드롭다운 (219L)
```
...
| `chat.css`      | 채팅 영역 전체 스타일       | 355  |
| `sidebar.css`   | 설정, 스킬 카드, 토글       | 215  |
| `modals.css`    | 모달, 하트비트 카드         | 171  |

**총 CSS**: 950L · **총 JS**: 1209L · **HTML**: 421L
