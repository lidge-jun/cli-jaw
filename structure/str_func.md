...
├── public/                   ← Web UI (Vite 8 + ES Modules, 432 files [source + assets + public/public/dist mirror, public/dist 제외], public/dist build output 456 files, mirrored copies under `public/public/dist/` and `public/dist/dist/`, ~60149L)
...
| [🎨 frontend.md](frontend.md)                       | public/ 전체 (소스/자산 432개, `public/dist` build 456파일 + mirrored copies) | ES Modules + CSS + Vite + PWA           |
